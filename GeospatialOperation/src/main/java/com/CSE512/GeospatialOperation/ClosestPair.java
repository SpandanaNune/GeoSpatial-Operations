...
public class ClosestPair {
	public static void sortByXcoordinate(List<Point> points){
		Collections.sort(points, new Comparator<Point>(){
			...
			public int compare(Point point1, Point point2) {
				if(point1.xco < point2.xco) return -1;
				if(point1.xco > point2.xco) return 1;
				return 0;
			}
		}
	...
	public static void sortByYcoordinate(List<Point> points){
		Collections.sort(points, new Comparator<Point>(){
			...
			public int compare(Point point1, Point point2) {
				if(point1.yco < point2.yco) return -1;
				if(point1.yco > point2.yco) return 1;
				return 0;
			}
		}
	...
	public static double pairdistance(Point p1, Point p2){
	  ...
	  public static Pair divideAndConquerBase(List<Point> listOfPoints)
	  {
	  ...
	  public static Pair bruteForceApproach(List<Point> listOfPoints)
	  {
	  ...
	  private static Pair divideAndConquerRecursionMethod(List<Point> pointsSortedByXcoordinate, List<Point> pointsSortedByYcoordinate)
	  {
	    ...
	    List<Point> leftPart = pointsSortedByXcoordinate.subList(0, dividingPoint);
	    List<Point> rightPart = pointsSortedByXcoordinate.subList(dividingPoint, numOfPoints);
	...
	public static void main(String[] args){
		...
		sc.addJar("/home/kulvir/Downloads/sparktest.jar");
